...
export default function Layout({ children }) {
  ...
  if (!session) {
    return (
      <div className="flex items-center flex-col gap-20 bg-gray-400 justify-center h-screen w-full">
        <h1 className="text-2xl text-blue-900 font-bold">Sign in to get started</h1>
  ...
  return (
    <div className="bg-green-950 min-h-screen ">
      ...
      <button className="pl-4 pt-4 md:hidden "
      ...
      <div className=" flex">
        <Nav show={showNav} />
        <div className="bg-gradient-to-b from-white to-gray-500 flex-grow text-black p-4 mb-2 mt-2 mx-2 rounded-lg min-h-[90vh] w-full">
